    ...
    <div className="flex flex-col gap-4 lg:flex-row md:gap-12 mt-12">
      ...
      <div className="w-full lg:w-7/12 flex flex-col gap-4">
        ...
        <p className="text-xs text-gray-500">
          ...
          <span className="underline hover:text-black">Terms and Conditions</span> and{" "} and <span className="underline hover:text-black">Privacy Policy</span>. You authorize us to change your selected payment method for the total amount shown.
